    ...
    <div className="py-24 max-w-[1280px] mx-auto px-6 md:px-12 text-left">
      ...
      >
        ...
        <div className="space-y-6 font-body text-base text-muted-foreground leading-relaxed">
          ...
          <p>
            Launched on 16th January 2016, the Start-up India Initiative has
            rolled out several programs to support entrepreneurs, build a robust
            start-up ecosystem and transforming India into a country of job
            creators instead of job seekers.
          </p>
          <p>
            In line with the Government of India's objectives, we at AECCI
            encouraging the youngsters to go for entrepreneurship and take
            advantage of the government's schemes. We conduct various sessions
            for the students to educate them to opt for start-ups so that more
            employment can be generated in the country, natural resources and
            available skills can be utilized to the best and people can become
            more self-reliant.
          </p>
