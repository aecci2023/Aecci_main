...
export default function AffiliateProgram() {
  ...
  return (
    <div className="py-24 max-w-[1280px] mx-auto px-6 md:px-12 text-left">
      ...
      >
        <span className="text-xs font-bold text-primary uppercase tracking-widest mb-3 block">Grow Together</span>
        <h1 className="font-heading font-black text-4xl md:text-5xl text-foreground mb-6">AECCI Affiliate Program</h1>
