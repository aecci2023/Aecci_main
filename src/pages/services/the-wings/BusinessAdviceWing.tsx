  ...
  return (
    <div className="py-24 max-w-[1280px] mx-auto px-6 md:px-12 text-left">
      ...
      >
        ...
        <h1 className="font-heading font-black text-4xl md:text-5xl text-foreground mb-8">Business Advice Wing</h1>
        ...
        <div className="space-y-6 font-body text-base text-muted-foreground leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
              <div className="bg-card border border-border p-6 rounded-2xl shadow-sm space-y-4">
                 <h3 className="font-heading font-bold text-lg text-foreground mb-2 flex items-center gap-2"><Phone className="size-5 text-primary" /> Exports Advice Wing's Division</h3>
                 <p className="text-[10px] text-primary uppercase tracking-widest font-bold mb-4">(Advice covering worldwide exports Pro's and Con's and any product/service)*</p>
                 <p className="text-sm"><span className="font-bold text-foreground">Email:</span> businessadvice@aecci.org.in</p>
                 <p className="text-sm"><span className="font-bold text-foreground">Board lines:</span> +91-22-412 711 45 | 46 | 47</p>
                 <p className="text-[10px] text-muted-foreground uppercase tracking-widest mt-4">*(Consultation available with prior appointment, consultation fee applicable)</p>
              </div>
