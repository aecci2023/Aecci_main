              ...
              {profiles.map((profile: any) => (
                <TableRow key={profile.id}>
                  ...
                  <TableCell>
                    <Badge
                      variant={
                        profile.status === "approved" ? "default" : "outline"
                      }
                    >
                      {profile.status}
                    </Badge>
            ...
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2">
                  ...
                  <p className="bg-muted p-3 rounded-md mt-1 text-sm">
              ...
              <div className="pt-4 border-t space-y-3">
                ...
                {selectedProfile.governmentId && (
                  <div>
                    <a
                      href={selectedProfile.governmentId}
                      target="_blank"
                ...
                {selectedProfile.businessProof && (
                  <div>
                    <a
                      href={selectedProfile.businessProof}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-primary hover:underline text-sm flex items-center gap-2"
                    >
                ...
                {selectedProfile.professionalCert && (
                  <div>
                    <a
                      href={selectedProfile.professionalCert}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-primary hover:underline text-sm flex items-center gap-2"
                    >
            ...
            {selectedProfile?.status === "pending_review" ? (
              <>
                <Button
                  ...
                  onClick={() =>
                    handleUpdateStatus(selectedProfile.userId, "rejected")
                  }
                  disabled={isUpdating}
                >
