...
export default function AdminSubscriptionsPage() {
  ...
  const stats = {
    ...
    market_entry: subscribed.filter((u) => u.planName === "market_entry")
      .length,
    ...
    <Main fluid className="space-y-6 max-w-7xl mx-auto py-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Overview of all active and lapsed plan subscriptions across the
          platform.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {[
          ...
          <div
            key={label}
            className="bg-background border rounded-lg p-4 space-y-1"
          >
