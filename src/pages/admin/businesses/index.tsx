    ...
    <Main fluid className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
            <Building2 className="size-8 text-primary" /> Business Accounts
          </h1>
          <p className="text-muted-foreground text-sm mt-1">
            Manage all registered corporate entities and exporters.
          </p>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="flex items-center justify-center h-64 border rounded-md border-destructive/50 bg-destructive/10">
          <p className="text-destructive">Failed to load businesses.</p>
        </div>
      ) : (
