  ...
  return (
    <div className="py-24 max-w-4xl mx-auto px-6 md:px-12 text-left">
      ...
      >
        ...
        <h1 className="font-heading font-black text-4xl md:text-5xl text-foreground mb-12">
          Strategic Partners
        </h1>

        <div className="space-y-16 font-body text-base text-muted-foreground leading-relaxed">
          <div className="bg-card border border-border p-8 rounded-2xl shadow-sm">
            <h2 className="font-heading font-black text-2xl text-foreground mb-4">
              EGC India
            </h2>
            <p className="mb-4">
            ...
            <div className="flex flex-col text-sm border-t border-border pt-4">
              ...
              <span className="font-bold text-foreground mt-1">
                Phone:{" "}
                <span className="font-normal ml-1">+91 720 804 6058</span>
              </span>
            </div>
          </div>
