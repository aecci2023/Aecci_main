...
const sampleMarkers: GlobeMarker[] = [
  ...
  { lat: 15.3694, lng: 44.191, src: "https://flagcdn.com/w80/ye.png", label: "Yemen" },
  { lat: 36.8065, lng: 10.1815, src: "https://flagcdn.com/w80/tn.png", label: "Tunisia" },
  { lat: 50.0755, lng: 14.4378, src: "https://flagcdn.com/w80/cz.png", label: "Czech Republic" },
  { lat: 40.4168, lng: -3.7038, src: "https://flagcdn.com/w80/es.png", label: "Spain" },
  { lat: 48.2082, lng: 16.3738, src: "https://flagcdn.com/w80/at.png", label: "Austria" },
];
        ...
        >
          <div className="absolute inset-0 z-10">
            <Globe3D
              ...
              config={{ atmosphereColor: "#2bb17b", atmosphereIntensity: 25, bumpScale: 5, autoRotateSpeed: 0.8 }}
            />
          </div>
      ...
      <section className="py-20 md:py-24 bg-background">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Badge variant="outline" className="mb-6 gap-1.5 px-3 py-1 text-sm border-primary/30 text-primary">
              <Zap className="w-3.5 h-3.5" />
              The Digital Trade Ecosystem
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">A Global Deal Room</h2>
            <p className="text-muted-foreground text-base md:text-lg leading-relaxed mb-4">
              More than a traditional chamber, AECCI is building a Global Deal Room — a digital ecosystem where Indian exporters, manufacturers, startups and service providers can directly engage with international trade experts, legal advisors, investment consultants and business organizations from across the globe.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Card className="border-border shadow-sm">
                <CardContent className="p-4 flex items-start gap-3">
                  <div className="p-2 bg-primary/10 rounded-lg text-primary shrink-0"><Users className="w-5 h-5" /></div>
                  <div>
                    <p className="font-semibold text-foreground text-sm">Direct Engagement</p>
                    <p className="text-xs text-muted-foreground">Connect with buyers &amp; partners</p>
                  </div>
                </CardContent>
              </Card>
              <Card className="border-border shadow-sm">
                <CardContent className="p-4 flex items-start gap-3">
                  <div className="p-2 bg-primary/10 rounded-lg text-primary shrink-0"><Target className="w-5 h-5" /></div>
                  <div>
                    <p className="font-semibold text-foreground text-sm">Expert Consultation</p>
                    <p className="text-xs text-muted-foreground">Legal &amp; trade advice</p>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          >
            <div className="aspect-square md:aspect-video lg:aspect-square bg-muted rounded-3xl overflow-hidden shadow-xl border border-border flex items-center justify-center p-8 relative">
              ...
              <div className="absolute -bottom-6 -left-6 md:-left-12 p-4 bg-card rounded-xl shadow-lg border border-border flex items-center gap-3 z-20">
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground">Trade Ecosystem</p>
                  <p className="text-xs text-muted-foreground">Expanding Network</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="bg-foreground p-10 md:p-16 flex flex-col justify-center">
              <h3 className="text-xl md:text-2xl font-bold mb-6 uppercase tracking-wider text-primary">Our Mission</h3>
            ...
            <div className="bg-primary p-10 md:p-16 flex flex-col justify-center order-3 md:order-4">
              <h3 className="text-xl md:text-2xl font-bold mb-6 uppercase tracking-wider text-primary-foreground">Our Vision</h3>
      ...
      <section className="py-20 md:py-24 bg-background">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-12">
            <span className="text-xs font-bold text-primary uppercase tracking-widest mb-3 block">What We Stand For</span>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Our Core Values</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
              The foundation of everything we do is built upon these guiding principles.
            </p>
          </div>
