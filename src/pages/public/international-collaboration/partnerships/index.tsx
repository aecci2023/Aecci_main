        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
          ...
          >
            ...
            <p className="text-background/70 text-base md:text-lg leading-relaxed">
              AECCI's global network of trusted legal, trade, and business
              partners spans {partners.length}+ countries, powering the Global
              Deal Room with on-the-ground expertise in every region.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto text-sm md:text-base leading-relaxed">
              Click any country to view the partner firm details, website, and
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {partners.map((partner, idx) => (
              ...
              >
                <Link
                  to={`/events/international-collaboration/partnerships/${partner.slug}`}
                >
                  <Card className="h-full border-border hover:border-primary/40 transition-colors group cursor-pointer">
                    <CardContent className="p-5 flex flex-col gap-3">
                      ...
                      {partner.firm ? (
                        ...
                        <Badge
                          variant="outline"
                          className="text-[10px] border-border w-fit"
                        >
                          Partner TBA
                        </Badge>
                      )}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-background/60 text-base max-w-xl mb-8">
              Connect with AECCI's partner network to access legal advisory,
              trade facilitation, and business matchmaking services across 50+
              countries.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              >
                <ArrowLeft className="size-4" /> Back to International
                Collaboration
              </Link>
            </div>
          </motion.div>
