          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                Why Advertise with AECCI?
              </h2>
              <p className="text-muted-foreground text-base leading-relaxed mb-4">
                Advertising with the Asian Exporters' Chamber of Commerce &
                Industry (AECCI) gives your brand direct exposure to a highly
                engaged audience of exporters, importers, manufacturers,
                business leaders, trade professionals, investors, and
                international partners.
              </p>
              <p className="text-muted-foreground text-base leading-relaxed">
                With the launch of the Global Deal Room, your business can reach
                not only Indian enterprises but also overseas buyers,
                distributors, trade experts, legal professionals, and business
                organizations actively seeking new partnerships and
                opportunities.
              </p>
            </motion.div>
              ...
              <Card className="border-border">
                <CardContent className="p-8">
                  <h3 className="text-lg font-bold text-foreground mb-2">
                    Our advertising solutions are designed to
                  </h3>
                  <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                    maximize your visibility while delivering measurable
                    business value. Whether your objective is to generate
                    quality leads, increase brand awareness, promote your
                    products and services, or expand into international markets,
                    AECCI provides the right platform.
                  </p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto text-sm md:text-base leading-relaxed">
              By leveraging AECCI's growing global business network, your brand
              gains visibility among decision-makers actively involved in
      ...
      <section className="py-20 md:py-24 bg-muted/30 border-b border-border">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto text-sm md:text-base leading-relaxed">
              From startups and MSMEs to established enterprises, we offer
              flexible advertising opportunities to suit every business size and
              marketing budget.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {packages.map((pkg, idx) => (
              ...
              >
                <Card
                  className={`h-full border-border hover:border-primary/40 transition-colors flex flex-col ${pkg.badge === "Popular" ? "border-primary/50 shadow-lg" : ""}`}
                >
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-muted-foreground text-base leading-relaxed mb-4">
                Every business has unique marketing objectives. That's why we
                work closely with you to create customized advertising campaigns
                that align with your industry, target audience and budget.
              </p>
              <p className="text-muted-foreground text-base leading-relaxed">
                Whether you're launching a new product, promoting your services,
                expanding into new markets or strengthening your brand presence,
                our team will help you design an effective campaign that
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <p className="text-muted-foreground text-base leading-relaxed mb-4">
                From startups and MSMEs to established enterprises, we offer
                flexible advertising opportunities to suit every business size
                and marketing budget.
              </p>
              <p className="text-muted-foreground text-base leading-relaxed">
                Our goal is simple — to help your business gain greater
                visibility, generate meaningful business connections and create
                lasting growth opportunities. Partner with AECCI and showcase
                your brand to a global audience through our trusted trade
                ecosystem and the Global Deal Room.
              </p>
            </motion.div>
              ...
              <Card className="border-border">
                <CardContent className="p-8 flex flex-col gap-5">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Explore advertising opportunities and find the package
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-background/60 text-base max-w-xl mb-8">
              Showcase your brand to a global audience through our trusted trade
              ecosystem and the Global Deal Room.
            </p>
            <a
              href="mailto:info@aecci.org.in"
