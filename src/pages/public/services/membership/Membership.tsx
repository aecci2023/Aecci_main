        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
          ...
          >
            ...
            <p className="text-background/70 text-base md:text-lg leading-relaxed">
              Membership with AECCI allows you to enjoy an exclusive and wide
              range of support and benefits for getting ahead in business —
              raising awareness of your brand, creating new business
              opportunities, building your network, and successfully reaching
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-background/60 text-base md:text-lg max-w-xl mb-8">
              Join thousands of businesses growing with AECCI's exclusive
              chamber network and international market access.
            </p>
            <Link
              to="/about"
