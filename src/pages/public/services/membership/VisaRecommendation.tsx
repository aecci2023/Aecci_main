        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
          ...
          >
            ...
            <p className="text-background/70 text-base md:text-lg leading-relaxed max-w-2xl">
              To help our exporter members in business promotion through
              overseas tours and personal meets, we provide VISA recommendation
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-10">
              <div className="space-y-4 text-muted-foreground text-base leading-relaxed">
                ...
                <p>
                  Asian Exporters' Chamber of Commerce &amp; Industry issues
                  Visa Recommendation Letters addressing foreign Consulates /
                  Embassies / High Commissions in India, to support the Visa
                  Applications of members. Normally, it takes{" "}
                  <strong className="text-foreground">two working days</strong>{" "}
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground text-base leading-relaxed">
                  Members of AECCI (Proprietors / Partners / Directors) are
                  required to submit the following documents along with a{" "}
                  <strong className="text-foreground">
                    Requesting Letter on applicant's letterhead
                  </strong>{" "}
                  stating the visiting country's name, applicant name,
                  designation, passport number, and passport details (date of
                  issue / expiry date etc.).
                </p>
                <p className="text-sm text-muted-foreground italic">
                  * Request Letter must be signed by the Authorized Signatory.
                </p>
              </div>
              ...
              <div className="space-y-3 text-muted-foreground text-sm leading-relaxed">
                ...
                <p>
                  The office bearers of the Chamber may interview any applicant
                  if they so desire while considering the application and may
                  call for supporting documents.
                </p>
                <p>
                  The Executive Director and office bearers are authorized to
                  consider the genuine needs of member firms. However, they
                  shall exercise discretion and take necessary measures so that
                  this important facility is not misused in any way.
                </p>
              </div>
            </div>
