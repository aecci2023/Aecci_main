    ...
    <div className="py-24 max-w-[1280px] mx-auto px-6 md:px-12 text-left">
      ...
      >
        ...
        <p className="font-body text-base text-muted-foreground leading-relaxed max-w-3xl mb-16">
          To encourage entrepreneurship, to kick-start innovative businesses
          that will eventually create employment opportunities, the government
          of India offers innumerable schemes to make the process easier &
          rewarding.
        </p>
