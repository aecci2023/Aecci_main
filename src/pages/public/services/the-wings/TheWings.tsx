    ...
    <div className="py-24 max-w-[1280px] mx-auto px-6 md:px-12 text-left">
      ...
      >
        ...
        <p className="font-body text-base text-muted-foreground leading-relaxed max-w-3xl mb-16">
          Combinations of highly educated and experienced professionals who are
          committed to providing expert consultations to our global business
          partners through the various stages of business – all under one roof.
        </p>
          ...
          {wings.map((svc, idx) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-1 text-left">
                ...
                <Link
                  to={svc.href}
                  className="inline-flex items-center text-[10px] font-bold text-primary hover:text-primary/80 uppercase tracking-widest group/btn mt-auto"
                >
                  {svc.btnText}{" "}
