      ...
      <main className="flex-grow pt-20 flex flex-col">
        <div className="container mx-auto px-4 py-8 max-w-5xl flex-grow flex flex-col">
          ...
          <div className="mt-8 text-sm text-muted-foreground text-center">
            Source:{" "}
            <a
              href="https://www.aecci.org.in/e-platform/formalities-guidelines/indemnity-bond-format/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary hover:underline"
            >
              https://www.aecci.org.in/e-platform/formalities-guidelines/indemnity-bond-format/
            </a>
          </div>
        </div>
      </main>
