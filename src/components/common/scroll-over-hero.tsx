...
function TitleStack({
  ...
  return (
    <div className="flex flex-col items-center px-6 text-center">
      ...
      <h1 className="mx-auto max-w-5xl text-balance text-4xl font-semibold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl">
        {title}
      </h1>
      {description && (
        <p className="mx-auto mt-5 max-w-3xl text-balance text-base text-muted-foreground md:mt-6 md:text-lg">
          {description}
        </p>
      )}
      {actions && (
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const measure = () => {
      ...
      if (
        ...
        titleBottom > window.innerHeight - MIN_PEEK
      ) {
        setState((s) =>
