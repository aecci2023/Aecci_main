...
export default function ArbitrationHero() {
  return (
    ...
    >
      {/* Dark overlay for text contrast on background image */}
      ...
      <div className="relative z-20 mx-auto max-w-[900px] px-6 md:px-12 text-center flex flex-col items-center">
        ...
        >
          <Badge className="bg-primary/20 hover:bg-primary/30 text-white text-xs font-bold px-4.5 py-1.5 rounded-full border border-primary/30 tracking-wide uppercase shadow-inner flex items-center gap-2">
        ...
        <motion.p
          ...
          className="font-body text-base md:text-lg text-slate-200 leading-relaxed mb-6 md:mb-10 max-w-3xl font-light"
        >
          AECCI–International Arbitration Centre (AECCI-IAC), Navi Mumbai has
          been included in the Arbitral Institutes Directory of the
          International Council for Commercial Arbitration (ICCA), reflecting
