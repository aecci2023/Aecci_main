...
export default function VirtualB2BForum() {
  return (
    <section
      id="virtual-b2b"
      className="py-12 md:py-24 bg-card/5 border-t border-border overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="font-body text-base text-muted-foreground leading-relaxed max-w-lg">
              Seize the opportunity to connect one-to-one with two distinguished
              experts coming this month from the United Kingdom and Vietnam—part
              of our 39 international collaborations.
            </p>
            <p className="font-body text-sm text-muted-foreground leading-relaxed max-w-lg">
              Book your slots to discuss trade potential, explore emerging
              markets, exchange business cards, and access exclusive
              international trade services. Tap into the expertise of our global
              network of partners and take the next step toward expanding your
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <Button
                variant="outline"
                className="rounded-full px-8 h-12 text-sm font-bold border-border bg-card/50 hover:bg-muted/50 text-foreground group"
              >
                Learn More{" "}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4 mt-12">
                <div className="bg-card border border-border p-6 rounded-2xl shadow-xl flex flex-col items-center text-center hover:border-primary/40 transition-colors">
                  ...
                  <p className="text-xs text-muted-foreground mb-4">
                    Join to connect and trade anytime, anywhere.
                  </p>
                  <Button
                    variant="outline"
              ...
              <div className="space-y-4">
                <div className="bg-card border border-border p-6 rounded-2xl shadow-xl flex flex-col items-center text-center hover:border-primary/40 transition-colors">
                  ...
                  <p className="text-xs text-muted-foreground mb-4">
                    Partner with us across 35+ countries.
                  </p>
                  <Button
                    variant="outline"
                    className="w-full text-xs font-bold rounded-full"
