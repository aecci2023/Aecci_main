            ...
            <div className="h-60 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={SECTOR_DATA} margin={{ left: -25, right: 10, bottom: 0, top: 10 }}>
                  ...
                  />
                  <Bar dataKey="volume" fill="oklch(0.67 0.17 153.85)" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </Card>
            ...
            <div>
              ...
              <div className="space-y-6 pt-2">
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-emerald-600 dark:text-emerald-400">99.87% Accuracy rate</p>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-sky-600 dark:text-sky-400">Secure API routing active</p>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-emerald-600 dark:text-emerald-400">Faster transit times</p>
                </div>
              </div>
            </div>
