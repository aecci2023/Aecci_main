      ...
      <div className="mx-auto max-w-[1280px] px-6 md:px-12 relative z-10 font-mono text-xs text-muted-foreground">
        <div className="text-center max-w-2xl mx-auto mb-16 font-sans">
          ...
          <h2 className="text-3xl md:text-5xl font-heading font-black text-foreground tracking-tight flex items-center justify-center gap-3">
            <LineChart className="size-8 text-primary shrink-0" /> LIVE BUSINESS
            INTELLIGENCE
          </h2>
          <p className="text-muted-foreground mt-4 text-base leading-relaxed font-light">
            Real-time market insights, attestation volumes, and trending product
            segments compiled from our digital shipping registries.
          </p>
        </div>

        {/* Dashboard Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          {/* Card 1: Trending Export Sectors Chart (6 columns) */}
          <Card className="lg:col-span-6 bg-card border-border rounded-2xl p-6 flex flex-col justify-between shadow-sm">
            <div>
              ...
              <p className="text-[11px] text-muted-foreground mb-6 font-sans font-light">
                Relative processing volume indexed by Certificate of Origin
            ...
            <div className="h-60 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  data={SECTOR_DATA}
                  margin={{ left: -25, right: 10, bottom: 0, top: 10 }}
                >
                  <CartesianGrid
                    strokeDasharray="3 3"
                    vertical={false}
          ...
          {/* Card 2: Sector List & Growth Rates (3 columns) */}
            ...
            <div>
              ...
              <div className="space-y-4">
                {SECTOR_DATA.map((item) => (
                  ...
                  >
                    <div>
                      <p className="font-bold text-foreground text-[11px] font-sans">
                        {item.name}
                      </p>
                      <p className="text-[9px] text-muted-foreground font-mono">
                        Index Score: {item.volume}
                      </p>
                    </div>
          ...
          {/* Card 3: Real-Time Performance Stats (3 columns) */}
          <Card className="lg:col-span-3 bg-card border-border rounded-2xl p-6 flex flex-col justify-between shadow-sm">
            <div>
              <div className="flex items-center gap-2 text-[10px] text-muted-foreground font-bold uppercase tracking-wider pb-3 border-b border-border mb-4 font-sans">
              ...
              <div className="space-y-6 pt-2">
                <div className="space-y-1">
                  <p className="text-[9px] text-muted-foreground font-bold uppercase tracking-widest">
                    Avg e-CO Attestation
                  </p>
                  <p className="text-3xl font-black text-foreground tracking-wide font-sans">
                    4m 12s
                  </p>
                ...
                <div className="space-y-1">
                  <p className="text-[9px] text-muted-foreground font-bold uppercase tracking-widest">
                    Daily Requests Filed
                  </p>
                  <p className="text-3xl font-black text-foreground tracking-wide font-sans">
                    1,842
                  </p>
                  <p className="text-[10px] text-sky-600 dark:text-sky-400">
                    Secure API routing active
                  </p>
                </div>

                <div className="space-y-1">
                  <p className="text-[9px] text-muted-foreground font-bold uppercase tracking-widest">
                    Port Clearance Uplift
                  </p>
                  <p className="text-3xl font-black text-foreground tracking-wide font-sans">
                    +65%
                  </p>
