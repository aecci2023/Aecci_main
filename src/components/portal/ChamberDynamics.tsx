        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {initiatives.map((item, idx) => (
            <motion.div
              ...
              className="group relative rounded-2xl border border-border/80 bg-card overflow-hidden shadow-lg hover:shadow-2xl hover:border-primary/45 transition-all duration-300 flex flex-col cursor-pointer"
            >
