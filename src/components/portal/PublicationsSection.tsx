...
const PUBLICATIONS_DATA: Publication[] = [
  ...
  },
  {
    ...
    categoryLabel: "Monthly Newsletter",
    date: "April 2026",
    coverImage: "https://images.unsplash.com/photo-1586075010923-2dd4570fb338?auto=format&fit=crop&q=80&w=600",
    readHref: "#",
    downloadHref: "#"
  },
  {
    ...
    categoryLabel: "Research Report",
    date: "February 2026",
    coverImage: "https://images.unsplash.com/photo-1578575437130-527eed3abbec?auto=format&fit=crop&q=80&w=600",
    readHref: "#",
    downloadHref: "#"
  }
]
...
export default function PublicationsSection() {
  const [activeTab, setActiveTab] = React.useState<"all" | "newsletter" | "magazine" | "report">("all")
  ...
  const handleSubscribe = (e: React.FormEvent) => {
    ...
    toast.success("Successfully subscribed to AECCI Publications & Chronicle digests!")
    setIsSubscribed(true)
    setEmail("")
  }

  return (
    <section id="publications" className="py-20 md:py-28 bg-background relative overflow-hidden border-b border-border">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 md:mb-16">
          <div className="text-left">
            ...
            <p className="font-body text-sm md:text-base text-muted-foreground mt-4 max-w-xl leading-relaxed">
              Explore our latest journals, monthly newsletters, and data-driven trade research reports covering Asian commerce and policies.
            </p>
          </div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            <div className="flex-1">
              ...
              <p className="font-body text-xs md:text-sm text-muted-foreground leading-relaxed max-w-xl">
                Get our monthly digests, compliance newsletters, and upcoming event invitations delivered directly to your inbox. No spam, unsubscribe anytime.
              </p>
            </div>
              ...
              {isSubscribed ? (
                <div className="flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-2xl text-emerald-400">
                  ...
                  <div className="text-sm text-left">
                    ...
                    <p className="text-xs text-emerald-300/80 mt-0.5">Thank you for joining AECCI trade insights newsletter.</p>
                  </div>
                </div>
              ) : (
