...
const STEPS = [
  ...
  },
  {
    ...
    icon: ShieldCheck,
    color:
      "text-emerald-650 dark:text-emerald-400 bg-emerald-500/10 border-emerald-500/25",
  },
  {
    step: "03",
  ...
  },
  {
    ...
    icon: Send,
    color:
      "text-purple-600 dark:text-purple-400 bg-purple-500/10 border-purple-500/25",
  },
  {
    step: "05",
      ...
      <div className="mx-auto max-w-[1280px] px-6 md:px-12 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-heading font-black text-foreground tracking-tight flex items-center justify-center gap-3">
            <Compass className="size-8 text-primary shrink-0" /> GLOBAL
            EXPANSION PATHWAY
          </h2>
          <p className="text-muted-foreground mt-4 text-base leading-relaxed font-light">
            Understand the structured path of launching your products overseas
            with verified matching, legal clearing, and logistical scale.
          </p>
        </div>
            ...
            return (
              <React.Fragment key={item.step}>
                ...
                >
                  {/* Step Bubble */}
                  <div
                    className={`size-11 rounded-xl border flex items-center justify-center mb-5 ${item.color} group-hover:scale-105 transition-transform`}
                  >
