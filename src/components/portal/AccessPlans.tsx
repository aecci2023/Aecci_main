...
const PLANS = [
  {
    ...
    ctaClass:
      "bg-muted/60 border border-border text-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary",
  },
  {
    name: "Premium",
    price: "₹14,999",
...
export default function AccessPlans() {
  return (
    <section
      id="pricing"
      className="bg-background py-16 md:py-24 relative border-b border-border/60 overflow-hidden"
    >
      ...
      <div className="mx-auto max-w-[1280px] px-6 md:px-12 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-foreground tracking-tight leading-[1.1] mb-4">
            Access Plans & <span className="text-primary">Memberships</span>
          </h2>
            ...
            <motion.div key={plan.name} variants={card} className="h-full">
              <Card
                className={cn(
                  ...
                  plan.isPopular
                    ? "bg-card shadow-xl hover:shadow-primary/10"
              ...
              >
                ...
                <CardHeader
                  className={cn("p-6 pb-4", plan.isPopular ? "pt-3" : "")}
                >
                  ...
                  <div className="flex items-baseline gap-1.5 mb-3">
                    ...
                    <span className="text-[9px] text-muted-foreground font-mono tracking-wider leading-none">
                      {plan.period}
                    </span>
                  </div>
                ...
                <CardFooter className="p-6 pt-0">
                  <Button
                    asChild
                    className={cn(
                      "w-full rounded-xl font-bold transition-all duration-300 text-xs",
                      plan.ctaClass,
                    )}
                  >
                    <a
