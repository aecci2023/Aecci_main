      ...
      <div className="mx-auto max-w-[1280px] px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch font-mono">
          ...
          <div className="lg:col-span-9 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="bg-card border-border rounded-2xl relative overflow-hidden p-6 md:col-span-2">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <p className="text-foreground/90 text-xs md:text-sm leading-relaxed font-sans font-light">
                    {current.overview}
                  </p>
                </motion.div>
              </AnimatePresence>
            ...
            {/* Box 2: Distributor Opportunities */}
            <Card className="bg-card border-border rounded-2xl p-6">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <p className="text-foreground/95 text-xs leading-relaxed font-light">
                    {current.opportunity}
                  </p>
                  <div className="flex gap-2">
                    <span className="text-[10px] bg-muted border border-border text-foreground px-2 py-0.5 rounded font-mono">
                      Target: Exporters
                    </span>
                    <span className="text-[10px] bg-amber-500/10 border border-amber-500/20 text-amber-600 dark:text-amber-400 px-2 py-0.5 rounded font-mono">
                      Slots Available
                    </span>
                  </div>
                </motion.div>
            ...
            {/* Box 4: AECCI Country Access Partner */}
            <Card className="bg-card border-border rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-4 text-xs font-bold text-muted-foreground uppercase tracking-widest pb-3 border-b border-border/60">
