...
export const menuConfig: MegaMenuSection[] = [
  ...
  },
  {
    ...
    quickLinks: [
      { title: "AECCI Affiliate Program", href: "#" },
      { title: "Arbitration Center", href: "/arbitration-center" },
      { title: "Media", href: "/media" },
    ],
    resources: [
      { title: "Export Wing", href: "#", description: "Certificates of origin & customs" },
      { title: "Legal Wing", href: "#", description: "Export dispute resolution & legalities" },
      { title: "HR Support Wing", href: "#", description: "Corporate and talent facilitation" },
      { title: "Professional Wing", href: "#", description: "Technical consultancies & certifications" },
      { title: "Business Advice Wing", href: "#", description: "Taxation and business strategy advice" },
      { title: "Women Wing", href: "#", description: "Empowering women entrepreneurs" },
      { title: "Event & Seminar Wing", href: "#", description: "Exhibitions & international seminars" },
    ],
  },
  {
    title: "e-Platform",
