    ...
    featured: [
      {
        ...
        href: "/about/about-chamber",
        description:
          "Pioneering trade facilitation and industry advocacy since 2005.",
      },
      // {
      //   title: "Our History",
      ...
      // },
      {
        ...
        description:
          "Leadership vision driving technological innovation and seamless exports.",
      },
      {
        title: "Chamber Policy",
        href: "/about/chamber-policy",
        description:
          "Unwavering commitment to ethical, progressive, and efficient commerce.",
      },
    ],
    quickLinks: [
        ...
        items: [
          {
            ...
            href: "/services/affiliate-program/meet-experts",
          },
          {
            title: "Join Our Affiliate Network",
            href: "/services/affiliate-program/join-network",
          },
        ],
      },
    ],
    ...
    featured: [
      {
        ...
        description:
          "International Arbitration Centre resolving cross-border disputes.",
      },
      {
        title: "Schedule Fees",
        href: "/arbitration-center/schedule-fees",
        description:
          "Transparent fee structures for streamlined dispute resolution.",
      },
      {
        title: "Panel of Arbitrators",
        href: "/arbitration-center/panel-of-arbitrators",
        description:
          "Distinguished panel of certified trade arbitrators and legal minds.",
      },
    ],
    quickLinks: [
      {
        title: "Rules and Policies",
        href: "/arbitration-center/rules-and-policies",
      },
      {
        title: "AECCI-IAC Model Clause",
        href: "/arbitration-center/model-clause",
      },
    ],
    resources: [
      {
        title: "AECCI-IAC FAQ",
        href: "/arbitration-center/faq",
        description: "Case management guidance",
      },
    ],
    mobileMenu: [
    ...
    featured: [
      {
        ...
        description:
          "Verified database of high-performing Asian exporting enterprises.",
      },
    ],
    mobileMenu: [
      {
    ...
    featured: [
      {
        ...
        description:
          "Latest press releases, video coverages, and industry news bulletins.",
      },
      {
        title: "Publications",
        href: "/media/publications",
        description:
          "A curated repository of export handbooks, manuals, and templates.",
      },
    ],
    quickLinks: [
  ...
  },
  {
    ...
    featured: [
      ...
      },
      {
        ...
        description:
          "Exhibitions and expos matching international trade buyers.",
      },
      {
        title: "Sponsorship",
        href: "/events/sponsorship",
        description:
          "Elevate your brand presence in premium international business events.",
      },
    ],
    quickLinks: [
    ...
    featured: [
      {
        ...
        description:
          "Access your dashboard to manage, track, and pay with ease.",
      },
      {
        title: "Request Trial Version",
        href: "https://e-platform.aecci.org.in/request-trial-version",
        description:
          "Experience our digital portal with a 14-day comprehensive trial.",
      },
      {
