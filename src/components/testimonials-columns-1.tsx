          ...
          ...new Array(2).fill(0).map((_, index) => (
            <React.Fragment key={index}>
              {props.testimonials.map(({ text, image, name, role }, i) => (
                <div
                  className="p-8 rounded-3xl border border-border bg-card/60 backdrop-blur-md shadow-lg shadow-primary/5 max-w-xs w-full text-left"
                  key={i}
                >
                  ...
                  <div className="flex items-center gap-3 mt-5">
                    ...
                    <div className="flex flex-col">
                      <div className="font-heading font-bold text-xs text-foreground tracking-tight leading-4">
                        {name}
                      </div>
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="mt-4 text-muted-foreground text-sm md:text-base">
            Hear from our registered members about how AECCI's trade
            facilitation, digital attestations, and compliance desks support
