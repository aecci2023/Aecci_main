    ...
    <SearchProvider>
      <LayoutProvider>
        <SidebarProvider defaultOpen={defaultOpen}>
          ...
          >
            {!isOnRoomPage && (
              <Header fixed className="h-16 bg-white border-b border-gray-200/80 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
                <div className="flex items-center justify-between gap-4 w-full h-full">
                  
                  {/* Left: Country selector pill card style */}
                  <div 
                  ...
                  {/* Right: GMT, Notification, Message, User Profile */}
                  <div className="flex items-center justify-between w-full md:w-auto gap-6 shrink-0 h-full">
                    ...
                    <div className="flex items-center gap-6 h-full">
                      ...
                      {/* User profile dropdown avatar card */}
