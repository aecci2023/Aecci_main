                ...
                <div className="mx-auto grid gap-4 lg:grid-cols-2">
                    <FeatureCard>
                        <CardHeader className="pb-3">
                            <CardHeading
                                icon={MapIcon}
                                title="e-CO Verification Tracking"
                                description="Instantly verify and audit the status of digital Certificates of Origin in real-time."
                            />
                        </CardHeader>
                    ...
                    <FeatureCard>
                        <CardHeader className="pb-3">
                            <CardHeading
                                icon={Calendar}
                                title="Attestation Scheduling"
                                description="Schedule physical document validation, desk appointments, and verification runs."
                            />
                        </CardHeader>
                    ...
                    <FeatureCard className="p-6 lg:col-span-2">
                        <p className="mx-auto my-6 max-w-md text-balance text-center text-2xl font-semibold">Automated multi-stage compliance pipelines and verification workflows.</p>
                        ...
                        <div className="flex justify-center gap-6 overflow-hidden">
                            ...
                            <CircularUI
                                label="Chamber Certified"
                                circles={[{ pattern: 'blue' }, { pattern: 'none' }]}
                            />

                            <CircularUI
                                label="Export Dispatched"
