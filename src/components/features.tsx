...
export default function ExporterTransactionsCard({
  ...
  return (
    <Card
      className={cn(
        "overflow-hidden border border-border shadow-md rounded-2xl",
        className,
      )}
    >
      {/* Header */}
      ...
      <CardContent className="p-0">
        <Table>
          <TableHeader className="bg-muted/40">
            <TableRow>
              <TableHead className="w-32 pl-6 font-semibold">
                Transaction ID
              </TableHead>
              ...
              <TableHead className="min-w-[120px] text-right pr-6 font-semibold">
                Processing Fee
              </TableHead>
            </TableRow>
          </TableHeader>
              ...
              >
                ...
                <TableCell>
                  ...
                  {txn.statusVariant === "danger" && (
                    <Badge
                      variant="destructive"
                      className="border-none font-bold uppercase text-[9px] tracking-wider"
                    >
                      {txn.status}
                    </Badge>
                  )}
                ...
                <TableCell className="text-right pr-6 font-semibold text-foreground tabular-nums">
                  {txn.fee}
                </TableCell>
              </TableRow>
            ))}
