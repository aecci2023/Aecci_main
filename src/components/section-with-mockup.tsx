...
const SectionWithMockup: React.FC<SectionWithMockupProps> = ({
    ...
    return (
        <section className="relative py-24 md:py-48 bg-white dark:bg-black overflow-hidden border-t border-b border-border/50">
                ...
                >
                    ...
                    >
                         <div className="space-y-2 md:space-y-1">
                            <h2 className="text-zinc-900 dark:text-white text-3xl md:text-[40px] font-semibold leading-tight md:leading-[53px]">
                                {title}
                            </h2>
                        </div>
                    ...
                    >
                        ...
                        <motion.div
                             className={`absolute w-[300px] h-[317px] md:w-[472px] md:h-[500px] bg-zinc-100 dark:bg-[#090909] rounded-[32px] z-0`}
                             style={{
                        ...
                        {/* Main Mockup Card */}
                        <motion.div
                            className="relative w-full h-[405px] md:h-[637px] bg-zinc-200/40 dark:bg-[#ffffff0a] border border-zinc-200/60 dark:border-white/5 rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] z-10 overflow-hidden"
                            initial={{ y: reverseLayout ? 0 : 0 }}
                            whileInView={{ y: reverseLayout ? 20 : 30 }}
